...
export const legacyRussian: Record<string, string> = {
  ...
  'Executable executions': 'Выполнения программ',
  'Executable execution': 'Выполнение программы',
  ...
  'See process creation, executable execution, process termination, thread activity, network activity, domains, and file operations observed for this application. Observations describe recorded activity, not configured intent, cause, or risk.':
    'Просматривайте создание процессов, выполнение программ, завершение процессов, активность потоков, сетевую активность, домены и файловые операции приложения. Наблюдения описывают зафиксированную активность, а не заданное поведение, причину или риск.',
  ...
  'Process created': 'Процесс создан',
  'Processes created': 'Создано процессов',
  'Programs executed': 'Выполнено программ',
  'Processes terminated': 'Завершено процессов',
  'Process lifecycle summary': 'Сводка жизненного цикла процессов',
  ...
  'Observed from process creation': 'Наблюдается с момента создания процесса',
  'Initialized from a process snapshot': 'Инициализировано по снимку процесса',
  'Initial thread state unavailable': 'Начальное состояние потоков недоступно',
  'Baseline provenance unavailable': 'Источник начального состояния недоступен',
  'Thread totals are lower bounds': 'Значения потоков являются нижними границами',
  'The bounded result omitted older windows. Counts prefixed with “At least” are incomplete.':
    'Ограниченный результат не включает старые окна. Значения с пометкой «Не менее» неполны.',
  ...
  'Previous windows': 'Предыдущие окна',
  'Next windows': 'Следующие окна',
